  ...
  return (
    <div style={{ padding: 28 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
        <span style={{ fontSize: 15, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--text-primary)" }}>Outbound Call History</span>
                ...
                {calls.map((call) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: "11px 16px" }}>
                        <button onClick={() => setSelectedCall(call)} style={{ fontSize: 11, color: "var(--blue)", background: "none", border: "none", cursor: "pointer", padding: 0 }}>View →</button>
                      </td>
                    </tr>
                  );
                })}
